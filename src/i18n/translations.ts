...
export const translations = {
  en: {
    ...
    "hero.subtitle"                             : "A lightweight, customizable modal library for React and Tailwind CSS",
    ...
    "docs.usage"                                : "Usage",
    "docs.api"                                  : "API",
    "footer.description"                        : "A lightweight and customizable React modal library for modern web applications.",
    "footer.links"                              : "Links",
    ...
    "propsTable.onClose.description"            : "Callback function called when the modal should close",
    ...
    "propsTable.showCloseButton.description"    : "Show/hide the close button in the header",
    "propsTable.closeOnOverlayClick.description": "Close the modal when clicking the overlay",
    "propsTable.closeOnEsc.description"         : "Close the modal when pressing ESC key",
  },
  es: {
    ...
    "hero.subtitle"                             : "Una biblioteca de modales ligera y personalizable para React y Tailwind CSS",
    "hero.cta"                                  : "Comenzar",
    ...
    "docs.usage"                                : "Uso",
    "docs.api"                                  : "API",
    "footer.description"                        : "Una biblioteca de modales React ligera y personalizable para aplicaciones web modernas.",
    ...
    "propsTable.onClose.description"            : "Función de callback llamada cuando el modal debe cerrarse",
    "propsTable.title.description"              : "Título mostrado en el encabezado del modal",
    ...
    "propsTable.showCloseButton.description"    : "Mostrar/ocultar el botón de cerrar en el encabezado",
    "propsTable.closeOnOverlayClick.description": "Cerrar el modal cuando se haga clic en el overlay",
    "propsTable.closeOnEsc.description"         : "Cerrar el modal al presionar la tecla ESC",
  },
} as const;
